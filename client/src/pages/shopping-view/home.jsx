    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className=" bg-orange-400">
        <div className="container p-12 text-center">
          <p className="uppercase text-white-900 text-xs tracking-widest">this weekend only</p>
          <h3 className="text-4xl text-white-900 py-8 uppercase font-bold tracking-widest">Sale</h3>
          <Button onClick={()=> navigate()} className="bg-white py-3 px-16 rounded-none">
