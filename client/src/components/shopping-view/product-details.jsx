      ...
      <DialogContent className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:p-12 max-w-[90vw] sm:max-w-[90vw] md:max-w-[100vw] max-h-screen overflow-y-auto">
        <div className="relative overflow-hidden rounded-lg">
          ...
          >
            ...
            <Button className="custom-prev absolute top-1/2 left-2 z-10 -translate-y-1/2 bg-black/50 text-white p-2 rounded-md">
              <ArrowLeftIcon />
            </Button>
        ...
        <div className="">
          <div>
            <h1 className="text-lg md:text-2xl font-extrabold">{productDetails?.title}</h1>
          ...
          <div className="mt-5 mb-5 flex item-center justify-between">
            {productDetails?.totalStock === 0 ? (
              <Button className="w-[49%] opacity-60 cursor-not-allowed">
                Out of Stock
              </Button>
            ) : (
              <Button
